...
public class PlaceApi {
    ...
    public ArrayList<String> autoComplete(String input){
        ...
        try {
            ...
            //https://maps.googleapis.com/maps/api/place/autocomplete/json?input=Rabat&key=AIzaSyCBqE4OUABGiP29SzLMV-Yn8bIttbAoxmY

            sb.append("input="+input);
            sb.append("&key=AIzaSyCBqE4OUABGiP29SzLMV-Yn8bIttbAoxmY");
